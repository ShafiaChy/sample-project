...
const Register = () => {
    ...
    return (
        <div className="pb-5">
             <h1 className="mt-5 d-flex justify-content-center">Hello, New Member!</h1>
        ...
        <p className="d-flex justify-content-center">or</p>
           ...
           <div className="d-flex justify-content-center">
           <button className="btn-dark rounded text-white py-2" onClick={handleGoogleSignIn}> Sign In With Google</button>
           </div>
